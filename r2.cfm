...
<p class="fs-6">This report is a follow up to the safety inspection completed on #GetRep.rep_yyyymmdd#. the
...
<cfset inc = #GetRep.rep_pages# + 4>

<div id="footer" style="white-space: nowrap;"><cfoutput>#GetRep.rep_pages#</cfoutput></div>
<!---  Page 1 end ---------------------------------------------------------------->
...
<div class="container">
<div id="footer" class="footer" style="text-align:center;"><cfoutput>#GetRep.rep_pages#</cfoutput></div>
</div>
 <!---  Page 5 end ---------------------------------------------------------------->
